...
以下のER図は、ドメインごとに分割して縦型に配置し、見やすさを向上させています。
...
erDiagram
    ...
    Users {
        ...
        string username UK
        string email UK
        string user_type "human/ai_agent"
...
erDiagram
    ...
    Workflows ||--o{ ApprovalFlows : uses
...
- **AIAgents/Executions**: AIの全行動を詳細記録
- **ApprovalFlows/Reviews**: Human-in-the-Loop承認プロセス
