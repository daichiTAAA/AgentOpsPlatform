...
erDiagram
    ...
    Users {
        int id PK "Redmine標準"
        string login UK "Redmine標準"
        string firstname "Redmine標準"
        string lastname "Redmine標準"
        string mail UK "Redmine標準"
        string hashed_password "Redmine標準"
        int status "Redmine標準: 1=active, 2=registered, 3=locked"
        boolean admin "Redmine標準"
        string language "Redmine標準"
    ...
    AuthSources {
        ...
        string host "Redmine標準"
        int port "Redmine標準"
        string account "Redmine標準"
        string account_password "Redmine標準"
        string base_dn "Redmine標準"
        string attr_login "Redmine標準"
        string attr_firstname "Redmine標準"
        string attr_lastname "Redmine標準"
        string attr_mail "Redmine標準"
        boolean onthefly_register "Redmine標準"
    }
    
    Tokens {
        int id PK "Redmine標準"
        int user_id FK "Redmine標準"
        string action "Redmine標準"
...
erDiagram
    ...
    Permissions {
        int id PK "Redmine標準"
        string controller "Redmine標準"
        string action "Redmine標準" 
        string description "Redmine標準"
        boolean is_public "Redmine標準"
        int sort "Redmine標準"
        boolean mail_option "Redmine標準"
        boolean mail_enabled "Redmine標準"
    }
...
erDiagram
    ...
    Projects {
        ...
        string homepage "Redmine標準"
        boolean is_public "Redmine標準"
        int parent_id FK "Redmine標準"
        int projects_count "Redmine標準"
        datetime created_on "Redmine標準"
        datetime updated_on "Redmine標準"
    }
    ...
    Trackers {
        int id PK "Redmine標準"
        string name "Redmine標準"
        boolean is_in_chlog "Redmine標準"
    }
    
    IssueStatuses {
        int id PK "Redmine標準"
        string name "Redmine標準"
        boolean is_closed "Redmine標準"
        boolean is_default "Redmine標準"
        string html_color "Redmine標準"
    }
...
erDiagram
    ...
    Journals {
        ...
        string journalized_type "Redmine標準"
        int user_id FK "Redmine標準"
    ...
    JournalDetails {
        ...
        string property "Redmine標準"
        string prop_key "Redmine標準"
        text old_value "Redmine標準"
        text value "Redmine標準"
    }
