...
erDiagram
    ...
    %% 関係性
    IssueCategories }o--|| Projects : "プロジェクト分類"
    Versions }o--|| Projects : "バージョン管理"
    IssueStatuses ||--o{ Issues : "ステータス"
    Issues }o--|| IssueCategories : "カテゴリ"
    Issues }o--|| Versions : "修正バージョン"
    Workflows }o--|| Trackers : "トラッカー"
    Workflows }o--|| IssueStatuses : "旧ステータス"
    Workflows }o--|| IssueStatuses : "新ステータス"
    Workflows }o--|| Roles : "ロール権限"
```
...
erDiagram
    ...
    %% 関係性
    IssueRelations }o--|| Issues : "関係元チケット"
    IssueRelations }o--|| Issues : "関係先チケット"
    Projects ||--o{ EnabledModules : "機能有効化"
    TimeEntries }o--|| Projects : "プロジェクト工数"
    TimeEntries }o--|| Users : "工数記録者"
    TimeEntries }o--|| Issues : "チケット工数"
    TimeEntries }o--|| Enumerations : "作業種別"
    Projects ||--o{ Queries : "プロジェクト検索"
    Users ||--o{ Queries : "検索作成者"
```
...
erDiagram
    ...
    ProjectExtensions ||--|| Projects : "プロジェクトAI拡張"
    ProjectExtensions }o--|| Organizations : "組織管理"
    ProjectExtensions }o--|| Users : "オーナー管理"
```
...
erDiagram
    ...
    IssueExtensions ||--|| Issues : "チケットAI拡張"
```
...
erDiagram
    ...
    Messages ||--o{ Messages : parent_child
    Users ||--o{ Messages : authors
    Projects ||--o{ Documents : has
    Documents ||--o| DocumentExtensions : extends
    News ||--o| NewsExtensions : extends
    Attachments ||--o| AttachmentAIAnalytics : analyzed_by
    Messages ||--o| MessageAIAssistant : assisted_by
...
erDiagram
    ...
    JournalDetails }o--|| Journals : contains
    Journals ||--o{ Issues : tracks_changes
    Issues }o--|| Watchers : watches
    Watchers ||--o{ Projects : watches
    Users ||--o{ Tokens : has
    Watchers }o--|| Users : watches_items
    Trackers ||--o{ Workflows : has_workflows
    IssueStatuses ||--o{ Workflows : from_status
    IssueStatuses ||--o{ Workflows : to_status
    Roles ||--o{ Workflows : requires_role
```
...
erDiagram
    ...
    %% 関係性
    Projects }o--|| Wikis : belongs_to
    Wikis ||--o{ WikiPages : contains
    WikiPages ||--o{ WikiContents : has_content
    WikiPages ||--o| WikiExtensions : extends
    WikiContents ||--o{ WikiContentVersions : versions
    Wikis ||--o{ WikiRedirects : redirects
    
    %% AI拡張との連携
    KnowledgeAssets }o--|| WikiPages : referenced_by
```
...
erDiagram
    ...
    WikiPages ||--o{ QualityChecks : wiki_checked
    ExecutionResults ||--o{ QualityChecks : ai_checked
```
...
erDiagram
    ...
    LearningProgress }o--|| LearningPlans : tracks
```
...
erDiagram
    ...
    Repositories ||--o{ Changesets : contains
    Changesets ||--o{ Changes : includes
    Users ||--o{ Repositories : manages
    Repositories ||--o{ RepositoryAIAnalytics : analyzed_for
    Changesets ||--o{ CodeReviewAssistant : reviewed_by
    Users ||--o{ CodeReviewAssistant : reviews
```
