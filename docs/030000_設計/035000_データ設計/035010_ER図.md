...
erDiagram
    ...
    %% 関係性
    Members }o--|| Projects : has
    Queries }o--|| Projects : has_queries
    Users ||--o{ Members : belongs_to
    Roles ||--o{ Members : has_role
    Projects ||--o{ Issues : contains
    Users ||--o{ Issues : authors
    Users ||--o{ Issues : assigned_to
    Issues ||--o{ IssueCategories : categorized_by
    Issues ||--o{ Versions : fixed_in
    Issues ||--o{ Enumerations : has_priority
    Issues ||--o{ IssueRelations : relates_to
    Projects ||--o{ TimeEntries : tracks_time
    Users ||--o{ TimeEntries : logs_time
    Issues ||--o{ TimeEntries : time_spent
    Enumerations ||--o{ TimeEntries : activity_type
    Users ||--o{ Queries : created_by
    Projects ||--o{ EnabledModules : enables
