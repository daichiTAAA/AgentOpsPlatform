...
classDiagram
    ...
    OrganizationType : SOLOPRENEUR
    OrganizationType : AI_NATIVE_COMPANY
    OrganizationType : TRADITIONAL_COMPANY
```
...
classDiagram
    ...
    Task ||--o{ WorkBreakdownStructure : "structured by"
...
classDiagram
    ...
    AIAgent ||--o{ Execution : "performs"
    Execution ||--|| ExecutionResult : "produces"
    AIAgent ||--o{ AgentCapability : "has"
    Execution ||--|| ExecutionContext : "uses"
    ExecutionResult ||--o{ Citation : "includes"
...
classDiagram
    ...
    WorkflowStep ||--o{ Approval : "requires"
    WorkflowStep ||--o{ Review : "includes"
    Workflow ||--o{ CollaborationSession : "spawns"
    
    <<enumeration>> WorkflowType
    WorkflowType : TASK_EXECUTION
    WorkflowType : APPROVAL_PROCESS
    WorkflowType : REVIEW_CYCLE
    WorkflowType : AI_TRAINING
...
classDiagram
    ...
    Event ||--o{ Trace : "contains"
    ComplianceRule ||--o{ AuditLog : "validates"
    AuditReport ||--o{ AuditLog : "aggregates"
...
classDiagram
    ...
    Integration ||--o{ SyncStatus : "monitors"
    
    <<enumeration>> IntegrationType
